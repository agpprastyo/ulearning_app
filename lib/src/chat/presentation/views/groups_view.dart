...
import 'package:ulearning_app/src/chat/presentation/widgets/other_group_tile.dart';
import 'package:ulearning_app/src/chat/presentation/widgets/your_group_tile.dart';
    ...
    return Scaffold(
      ...
      body: BlocConsumer<ChatCubit, ChatState>(
        ...
        builder: (context, state) {
          ...
          } else if ((state is GroupsLoaded) || (yourGroups.isNotEmpty) ||
